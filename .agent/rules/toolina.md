...
- **代码原则**：修改前端界面的时候，需要注意不要随意更改后端接口，后端代码修改前需要询问
...
You design production-quality SaaS interfaces.
...
USER:
Generate an AI hairstyle recommendation page UI.

Requirements:
- Centered layout
- Step-based flow: Upload → Analyze → Recommend
- Card-based design
- Rectangular elements with subtle rounded corners
- Clear primary CTA
