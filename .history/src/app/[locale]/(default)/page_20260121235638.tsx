  ...
  return (<div className="min-h-screen bg-slate-50 text-slate-900 overflow-x-hidden">
    ...
    <Dialog open={showDetectionFailed} onOpenChange={setShowDetectionFailed}>
      ...
      >
        ...
        {/* 确认按钮 - 底部留白 20px，16px 字体，品牌主题色，响应式设计 */}
        <div className="mt-6 flex justify-center pb-5">
          <button
            onClick={() => setShowDetectionFailed(false)}
            className="w-full sm:w-auto px-8 py-3 text-base sm:text-[16px] font-medium text-white bg-[#4a90e2] hover:bg-[#3a7bc8] active:bg-[#2d6ba8] rounded-lg shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#4a90e2] focus:ring-offset-2 border-none cursor-pointer min-w-[120px] sm:min-w-[140px]"
            style={{
              fontSize: '16px',
              fontWeight: 500,
            }}
