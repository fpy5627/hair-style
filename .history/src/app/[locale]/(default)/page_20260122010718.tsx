  ...
  return (<div className="min-h-screen bg-slate-50 text-slate-900 overflow-x-hidden">
    ...
    <Dialog open={showDetectionFailed} onOpenChange={setShowDetectionFailed}>
      <DialogContent 
        ...
        className="!relative !w-[95%] sm:!w-[85%] !max-w-[800px] !max-h-[80vh] !bg-slate-100/95 !backdrop-blur-[10px] !border !border-slate-200/60 !rounded !shadow-lg !p-8 focus:outline-none overflow-y-auto !m-0"
        style={{
          position: 'relative',
          width: '95%',
          maxWidth: '800px',
