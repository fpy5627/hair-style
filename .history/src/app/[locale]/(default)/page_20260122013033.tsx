  ...
  return (<div className="min-h-screen bg-slate-50 text-slate-900 overflow-x-hidden">
    ...
    <Dialog open={showDetectionFailed} onOpenChange={setShowDetectionFailed}>
      <DialogContent 
        ...
        className="!fixed !left-[58%] sm:!left-[63%] !top-[75%] sm:!top-[80%] !-translate-x-1/2 !-translate-y-[40%] !w-[90%] sm:!w-[80%] !max-w-[600px] !min-h-[500px] !max-h-[85vh] !bg-white !border-none !shadow-[0_4px_10px_rgba(0,0,0,0.2)] !p-5 sm:!p-8 focus:outline-none overflow-y-auto !m-0 !z-[1001] !text-center"
        style={{
          position: 'relative',
          top: '75%',
          left: '58%',
