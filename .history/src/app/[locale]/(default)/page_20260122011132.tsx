  ...
  return (<div className="min-h-screen bg-slate-50 text-slate-900 overflow-x-hidden">
    ...
    <Dialog open={showDetectionFailed} onOpenChange={setShowDetectionFailed}>
      <DialogContent 
        ...
        className="!fixed !left-1/2 !top-1/2 !-translate-x-1/2 !-translate-y-1/2 !w-[95%] sm:!w-[85%] md:!w-[75%] !max-w-[800px] !max-h-[85vh] sm:!max-h-[80vh] !bg-slate-100/95 !backdrop-blur-[10px] !border !border-slate-200/60 !rounded !shadow-lg !p-6 sm:!p-8 focus:outline-none overflow-y-auto !m-0 !z-[101]"
        style={{
          position: 'fixed',
          top: '50%',
          left: '50%',
