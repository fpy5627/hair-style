  ...
  return (<div className="min-h-screen bg-slate-50 text-slate-900 overflow-x-hidden">
    ...
    <Dialog open={showDetectionFailed} onOpenChange={setShowDetectionFailed}>
      <DialogContent 
        ...
        className="!fixed !left-1/2 !top-1/2 !-translate-x-1/2 !-translate-y-1/2 !w-[80%] !max-w-[600px] !min-h-[500px] !max-h-[85vh] !bg-white !border-none !rounded-lg !shadow-[0_4px_8px_rgba(0,0,0,0.1)] !p-8 sm:!p-10 focus:outline-none overflow-y-auto !m-0 !z-[1000]"
        style={{
          position: 'fixed',
          top: '50%',
          left: '50%',
      ...
      >
        ...
        {/* 确认按钮 - 底部留白 30px，高度50px，16px加粗字体，居中 */}
        <div className="mt-8 flex justify-center" style={{ paddingBottom: '30px' }}>
          <button
            onClick={() => setShowDetectionFailed(false)}
            className="w-full sm:w-auto px-10 h-[50px] text-[16px] font-bold text-white bg-[#6c63ff] hover:bg-[#5a53e6] active:bg-[#5a53e6] rounded-lg shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#6c63ff] focus:ring-offset-2 border-none cursor-pointer min-w-[160px] sm:min-w-[180px]"
            style={{
              fontSize: '16px',
              fontWeight: 700,
              height: '50px',
